...
export interface ApiFormSubmissionFormSubmission
  ...
  info: {
    displayName: 'Soumission de formulaire';
...
export interface ApiFormForm extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Constructeur de formulaires r\u00E9utilisables';
  ...
  attributes: {
    ...
    successMessage: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Merci, votre demande a bien \u00E9t\u00E9 envoy\u00E9e.'>;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pages \u00E9ditoriales WeSoft construites avec une zone dynamique';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.process',
        'sections.business-characteristics',
        'sections.metrics',
        'sections.cta',
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Navigation, bouton d\u2019en-t\u00EAte et footer global';
  ...
  attributes: {
    ...
    footerColumns: Schema.Attribute.Component<'shared.footer-column', true> &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    footerCtaTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Un projet ?'>;
    footerIntro: Schema.Attribute.Text;
    headerButton: Schema.Attribute.Component<'shared.button', false>;
    legalLinks: Schema.Attribute.Component<'shared.nav-child', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'WeSoft'>;
    socialLinks: Schema.Attribute.Component<'shared.nav-child', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
